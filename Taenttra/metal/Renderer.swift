...
class Renderer: NSObject, MTKViewDelegate {
    ...
    class func buildMetalVertexDescriptor() -> MTLVertexDescriptor {
        ...
        mtlVertexDescriptor.attributes[VertexAttribute.position.rawValue]
        ...
        mtlVertexDescriptor.layouts[BufferIndex.meshPositions.rawValue].stride =
            12
        mtlVertexDescriptor.layouts[BufferIndex.meshPositions.rawValue]
            .stepRate = 1
        mtlVertexDescriptor.layouts[BufferIndex.meshPositions.rawValue]
            .stepFunction = MTLVertexStepFunction.perVertex

        mtlVertexDescriptor.layouts[BufferIndex.meshGenerics.rawValue].stride =
            8
...
func matrix4x4_translation(
    _ translationX: Float,
    _ translationY: Float,
